                    ...
                    <ul class="list-inline mb-0">
                        <?php foreach ($usuarios_proyecto as $usuario): ?>
                            <li class="list-inline-item">
                                <span class="badge bg-info"><?php echo ($usuario['username']); ?></span>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            ...
            <?php foreach ($tareas as $tarea): ?>
                <div class="list-group-item">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-1"><?php echo ($tarea['title']); ?></h5>
                            <?php if (isset($tarea['description']) && !empty($tarea['description'])): ?>
                                <p class="mb-1"><?php echo ($tarea['description']); ?></p>
                            <?php endif; ?>
                            <small class="text-muted">Creada por: <?php echo ($tarea['creator_username']); ?></small>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
